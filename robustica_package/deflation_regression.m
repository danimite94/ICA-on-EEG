...
% Performs deflation by subtracting the estimated source contribution to the
% observations as:
% 
%    X' = X - h*s
% 
% The source direction h is estimated via the least squares solution to the linear
% regression problem:
%
...
if s2 > eps         % don't perform subtraction if estimated component is null
...
% with dimensionality reduction
    ...
    Q = [h, eye(n, n-1)];          
    [Q, R] = qr(Q);                 
    Q = Q(:,2:n);   % orthonormal base of orhogonal subspace of h
